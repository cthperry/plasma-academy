...
> P0–P4 已全數完成:26 章內容、33 個互動元件、350 題題庫、術語表與公式手冊皆已上線 —— 見下方「現況」。

## 這是什麼

一套給**半導體/面板廠製程工程師**的電漿(Plasma)線上教育訓練網站的完整內容規劃。

從「電漿到底是什麼」開始,一路走到「原子層蝕刻與機台匹配」,分成四個階段、26 個模組、約 65.5 小時的課程。每個關鍵概念都搭配可調參數的互動動畫,讓工程師不是背公式,而是**看見參數怎麼影響電漿、電漿怎麼影響晶圓**。
...
| **L3** | 進階:製程應用與整合 | 25.5 h | 8 | 蝕刻/沉積怎麼做出來的?profile 歪掉是誰的錯? |
...
- [x] **P0 網站骨架與共用元件庫**
- [x] **P1~P4:26 章內容、33 個互動元件、測驗中心、術語表、公式手冊、進度/徽章/證書全部上線**
- [ ] 已知未達成項目(A18 部分 profile、4.6 互動元件等):見 [`docs/11-build-roadmap.md`](docs/11-build-roadmap.md) 與 [`docs/13-plan-review.md`](docs/13-plan-review.md)
...
| 資料 | 課程結構(P0 當時 25 模組,現已 26 模組)、術語表(P0 當時 242 條,現已 247 條,由 markdown 自動產生) |
