        ...
        setup: function () {
          ...
          api.el.appendChild(
            C.observations([
              ...
              "⚠ 目前只有垂直、Footing、Faceting、Etch stop 四種預設達到「特徵明確可辨」;Undercut、Taper、Bowing、Microtrench 的預設參數仍在收斂中(見 docs/11 的 A18 實作紀錄)。",
            ])
          );
        },
